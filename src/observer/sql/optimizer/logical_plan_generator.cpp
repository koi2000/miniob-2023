...
RC LogicalPlanGenerator::create_plan(SelectStmt* select_stmt, unique_ptr<LogicalOperator>& logical_operator) {
    ...
    auto process_one_table = [/*, &all_fields*/](unique_ptr<LogicalOperator>& prev_oper, BaseTable* table,
                                                 FilterStmt* fu) {
        ...
        if (table->is_table()) {
            unique_ptr<LogicalOperator> table_get(
                new TableGetLogicalOperator(static_cast<Table*>(table), fields, true /*readonly*/));
...
RC LogicalPlanGenerator::create_plan(OrderByStmt* order_by_stmt, unique_ptr<LogicalOperator>& logical_operator) {
    ...
    unique_ptr<LogicalOperator> orderby_oper(new OrderByLogicalOperator(std::move(order_by_stmt->get_orderby_units()),
