...
public:
  ...
  RC check_field(const std::unordered_map<std::string, BaseTable *> &table_map, const std::vector<BaseTable *> &tables,
      BaseTable *default_table = nullptr, const std::unordered_map<std::string, std::string> &table_alias_map = {});
