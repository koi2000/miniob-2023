...
public:
  ...
  virtual RC spec_at(int index, TupleCellSpec &spec) const {
...
public:
  ...
  std::unordered_map<const BaseTable *, RID> &get_table_rid_map() { return tables_rid_; }

  void clear_map() { tables_rid_.clear(); }
...
public:
  ...
  int get_tuple_size() const override { return tuple_->get_tuple_size(); }
  RC  get_tuple_rid(int tuple_idx, const BaseTable *&table, RID &rid) const override
  {
...
public:
  ...
  int get_tuple_size() const override { return 0; }
  RC  get_tuple_rid(int tuple_idx, const BaseTable *&table, RID &rid) const override { return RC::INVALID_ARGUMENT; }
...
public:
  ...
  int get_tuple_size() const override { return left_->get_tuple_size() + right_->get_tuple_size(); }
  RC  get_tuple_rid(int tuple_idx, const BaseTable *&table, RID &rid) const override
  {
...
public:
  ...
  int get_tuple_size() const override { return 0; }
  RC  get_tuple_rid(int tuple_idx, const BaseTable *&table, RID &rid) const override { return RC::INTERNAL; }

  void init(
      std::vector<std::unique_ptr<AggrFuncExpr>> &&aggr_exprs, std::vector<std::unique_ptr<FieldExpr>> &&field_exprs)
  {
  ...
  public:
    ...
    void                              reset() {}
    const Value                      &result() const { return result_; }
    void                              set_expr(std::unique_ptr<FieldExpr> expr) { expr_ = std::move(expr); }
    const std::unique_ptr<FieldExpr> &expr() const { return expr_; }
