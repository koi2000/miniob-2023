...
ForwardIterator
lower_bound(ForwardIterator first, ForwardIterator last, const T& val, Compare comp, bool* _found = nullptr) {
    bool found = false;
...
template <typename T, typename Distance = ptrdiff_t> class BinaryIterator {
  public:
